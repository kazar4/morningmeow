...
form.addEventListener('submit', function(ev) {
  ...
  if (!validateForm()){
    console.log("needs validation -regular form")
  } else {
  ...
  stripe.confirmCardPayment(clientSecret, {
    ...
    if (result.error) {
      ...
      if (result.paymentIntent.status === 'amount_capturable_updated') {
        console.log("Payment success")
        //connect();
        //allowPayment()
  ...
  <form id="payment-form">
    ...
    <div class="container-contact100-form-btn">
					<button class="contact100-form-btn" type="submit">
						<span>
							<i class="fa fa-paper-plane-o m-r-6" aria-hidden="true"></i> Pay!
						</span>
					</button>
    </div>
  </form>    
